...
export default function ProfileForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      ...
      let avatar_url: string | null = initialAvatarUrl;
      ...
      const profileUpdate: { username: string; avatar_url?: string | null } = {
        username,
        avatar_url,
      };
      ...
      if (profileError) {
        setFeedback({
          type: "error",
          message: `Error al guardar: ${profileError.message}`,
        });
        return;
      }
    ...
    >
      ...
      <div className="mb-8">
        ...
        <p className="text-sm" style={{ color: "var(--text-secondary)" }}>
          Actualiza tu nombre de usuario y foto
        </p>
      </div>
